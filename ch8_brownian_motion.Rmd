...
\soln To show that $Z_n/\mu^n$ is a martingale, we must show that the martingale property holds and the absolute expectation is bounded for all $n$. Let $0 \le t < n$ be a time before time $n$.
